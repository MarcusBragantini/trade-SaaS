...
const clientConfigRoutes = require('./routes/client-config');
const realtimeAnalysisRoutes = require('./routes/realtime-analysis');
...
app.use('/api/v1/client-config', authMiddleware, clientConfigRoutes);
app.use('/api/v1/realtime-analysis', authMiddleware, realtimeAnalysisRoutes);
